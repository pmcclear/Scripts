...
fileNameLC = r'C:\Users\patmcc\Desktop\TestData\DATA_1108\Laptop1\ShakerTest7_LWP_7020_600hz.csv'
...
# data_filter = butter_lowpass_filter(data, .5, Fs, 2)
data_filter = pwc(data, int(30 * (Fs/120)))
